...
#define TIERED_MASTERNODES_START_BLOCK         5000// tiered mns 1st block
using namespace std;
...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 3000) (2, 6000) (3, 15000) (4, 25000) ; 
static std::map<int, int> masternodeTierRewardsLVL1 = map_list_of (1, 8) (2, 17) (3, 45) (4, 80) ;
static std::map<int, int> masternodeTierRewardsLVL2 = map_list_of (1, 7) (2, 15) (3, 36) (4, 64) ;
static std::map<int, int> masternodeTierRewardsLVL3 = map_list_of (1, 5) (2, 11) (3, 29) (4, 52) ;
//
// The Masternode Class. For managing the darksend process. It contains the input of the 500 MBLC, signature to prove
