	...
	nWeight(0)
{
	...
	montcardPage = new MontCard(this);
	...
	centralStackedWidget->addWidget(montcardPage);
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a MontBlanc address"));
	...
	MontCardAction = new QAction(QIcon(":/icons/montcard"), tr("&MontCard"), this);
	MontCardAction->setToolTip(tr("MontCard operations"));
	MontCardAction->setCheckable(true);
	tabGroup->addAction(MontCardAction);
	...
	connect(MontCardAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
	connect(MontCardAction, SIGNAL(triggered()), this, SLOT(gotoMontCard()));

	quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
	quitAction->setToolTip(tr("Quit application"));
	quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
	quitAction->setMenuRole(QAction::QuitRole);
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About MontBlanc"), this);
	aboutAction->setToolTip(tr("Show information about MontBlanc"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for MontBlanc"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->addAction(MontCardAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("MontBlanc client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("MontBlanc client"));
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MontBlanc network", "", count));
}
...
void BitcoinGUI::gotoMontCard()
{
	MontCardAction->setChecked(true);
	centralStackedWidget->setCurrentWidget(montcardPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MontBlanc address or malformed URI parameters."));
	}
