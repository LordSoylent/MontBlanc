...
private slots:
    ...
    QString BuyMBLC(QString OrderType, double Quantity, double Rate);
    QString SellMBLC(QString OrderType, double Quantity, double Rate);
